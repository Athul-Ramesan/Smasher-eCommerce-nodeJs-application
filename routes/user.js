...
router.get('/home',auth.verifyUser, userController.home)
...
router.get('/productView/:id',auth.verifyUser, productController.getProductView)

router.get('/shopProduct',auth.verifyUser, productController.getShopProduct)
